...
public class Workout extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        workOutList.add(new WorkoutModel("SQUAT", "A squat is a strength exercise in which the trainee lowers their hips from a standing position and then stands back up. During the descent, the hip and knee joints flex while the ankle joint dorsiflexions; conversely the hip and knee joints extend and the ankle joint plantar flexes when standing up.", R.drawable.squat));
        workOutList.add(new WorkoutModel("THE BENCH PRESS", "The bench press is a compound exercise that targets the muscles of the upper body. It involves lying on a bench and pressing weight upward using either a barbell or a pair of dumbbells. During a bench press, you lower the weight down to chest level and then press upwards while extending your arms.", R.drawable.benchpress));
        workOutList.add(new WorkoutModel("THE OVERHEAD PRESS", "The overhead press is an upper-body weight training exercise in which the trainee presses a weight overhead while seated or standing. It is mainly used to develop the anterior deltoid muscles of the shoulder.", R.drawable.overhead_press));
        workOutList.add(new WorkoutModel("THE LUNGE", "Stand with your feet hip-width apart. Step forward and bend both knees, lowering until your knees are bent at a 90-degree angle. Shift forward onto the lead leg. Push off on both legs and step through, lifting your back leg and bringing it forward so your rear foot lands ahead of you in a lunge position.", R.drawable.lunge));
        workOutList.add(new WorkoutModel("THE BULGARIAN SPLIT SQUAT", "A Bulgarian split squat is essentially a single-leg squat. Your back leg is elevated behind you on a steady box, chair, or bench, and your weight is loaded onto your front leg. It's a unilateral move that targets your quads, hamstrings, glutes, and calves.", R.drawable.bulgarian));
